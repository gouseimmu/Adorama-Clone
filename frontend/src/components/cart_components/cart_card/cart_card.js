...
<div><img Style={"width: 3%;position: relative;left: 46.7%;"} src={cross} onClick={hendleDelete_cart_item} /></div>
<div className="cart_card_details" >
        ...
        <div className="cart_cart_qty" ><Button disabled={item_count==1} onClick={hendle_reduce_button} >-</Button><span>{item_count}</span><Button onClick={hendle_increase_button} >+</Button></div>
